...
<Select
  ...
  required
/>
    <button type="button" id="add_run" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="50" height="50">
  ...
  <path fill="none" stroke="#2C3E50" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" d="M10,55c0,0,11.3-0.7,15-3s20.3-25.3,22.5-29c2.4-3.7-11.8-9.6-11.8-9.6s-3.3-2.1-5.3-1.1s0.1,4.3,1.6,6.3c1.5,2,0,4.9-3.2,4.4c-1.4-0.2-7-0.9-7-0.9s0.1,3.8-0.8,8.9c-0.9,5.4-1.2,9.4-3.8,12.8S8.7,48.3,8,51S10,55,10,55z"/>
  <polyline fill="#8C623B" points="28.4,55 39.2,42.2 42.6,55 52.4,42.2 56,55"/>
  <polyline fill="none" stroke="#2C3E50" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" points="28.4,55 39.2,42.2 42.6,55 52.4,42.2 56,55"/>
  <path fill="none" stroke="#2C3E50" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" d="M8.2,53.3c0,0,11-1.9,14-3.3s12.1-13.1,14-15.9S46,19.3,46,19.3"/>
  <line x1="21.2" y1="29.3" x2="31.9" y2="34.2" stroke="#2C3E50" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none"/>
  <line x1="20.7" y1="32.8" x2="29.9" y2="37.1" stroke="#2C3E50" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none"/>
  <line x1="20.1" y1="36.3" x2="27.8" y2="40" stroke="#2C3E50" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none"/>
  <path d="M41.1,26.3c-3.5-2.5-4.6-7.2-2.5-11" stroke="#2C3E50" stroke-width="2" stroke-dasharray="0,3" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none"/>
</svg>
Add run</button>

                </div>
                <div className="form-group" style={{  display:'grid' ,gridTemplateColumns:'1fr 1fr',gap:'1.5rem',direction: 'rtl' ,zIndex:'3',position:'relative',fontWeight:'500'}}>

    <button type="button" id="wicket" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="36" height="36">
...
Wicket</button>
    ...
    <button type="button" id="undo_ball" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="36" height="36">
  <circle cx="256" cy="256" r="238" fill="#4DB6AC"/>
  <polygon fill="none" stroke="#FFFFFF" stroke-width="16" stroke-linecap="round" stroke-linejoin="round"
...
Undo Last Ball</button>
    ...
    <button type="button" id="end_inning" class="btn btn-success">
End Inning <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="35" height="35">
  ...
  <line x1="190" y1="120" x2="280" y2="350" stroke="#FFFFFF" stroke-width="16" stroke-linecap="round"/>
  <path d="M190,120 
           c30,10 60,0 90,10 
           s60,0 90,10 
           v60 
