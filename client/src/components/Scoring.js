          ...
          <form>
            ...
            >
              <Select
                ...
                options={bowlers}
                value={
                  bowlers.find((opt) => opt.value === selectedbowler) || null
                }
                ...
                required
              />
              <button type="button" id="add_run" className="btn btn-success">
                <svg
                ...
                >
                  <path
                    fill="#EA685E"
                    d="M10,55c0,0,11.3-0.7,15-3s20.3-25.3,22.5-29c2.4-3.7-11.8-9.6-11.8-9.6s-3.3-2.1-5.3-1.1s0.1,4.3,1.6,6.3c1.5,2,0,4.9-3.2,4.4c-1.4-0.2-7-0.9-7-0.9s0.1,3.8-0.8,8.9c-0.9,5.4-1.2,9.4-3.8,12.8S8.7,48.3,8,51S10,55,10,55z"
                  />
                  <path
                    fill="#E64C3C"
                    d="M38.9,14.9l-0.3,0.3c-2.1,3.8-1,8.6,2.5,11l3.2,1.5c1.6-2.2,2.7-3.9,3.2-4.7C49.1,20.5,43,16.9,38.9,14.9z"
                  />
                  <path
                    fill="#F8B319"
                    d="M46,19.3c0,0-7.9,12-9.8,14.8c-1.9,2.8-11,14.5-14,15.9c-3,1.4-14,3.3-14,3.3C8.8,54.4,10,55,10,55s11.3-0.7,15-3c3.7-2.3,20.3-25.3,22.5-29C48.2,21.9,47.4,20.6,46,19.3z"
                  />
                  <path
                    fill="none"
                    stroke="#2C3E50"
                  ...
                  <polyline
                    fill="#8C623B"
                    points="28.4,55 39.2,42.2 42.6,55 52.4,42.2 56,55"
                  />
                  <polyline
                    fill="none"
                    stroke="#2C3E50"
                  ...
                  <path
                    ...
                    strokeMiterlimit="10"
                    strokeWidth="2"
                    d="M8.2,53.3c0,0,11-1.9,14-3.3s12.1-13.1,14-15.9S46,19.3,46,19.3"
                  />
                  <line
                    x1="21.2"
                    y1="29.3"
                  ...
                  />
                  <path
                    d="M41.1,26.3c-3.5-2.5-4.6-7.2-2.5-11"
                    stroke="#2C3E50"
                    strokeWidth="2"
                    strokeDasharray="0,3"
                    strokeLinecap="round"
            ...
            >
              <button type="button" id="wicket" className="btn btn-success">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  width="36"
            ...
            >
              <button type="button" id="undo_ball" className="btn btn-success">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  width="36"
