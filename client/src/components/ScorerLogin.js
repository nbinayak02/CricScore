...
//api call for login
  const response = await fetch(`${host}/auth/login/scorer`, {
    method: "POST",
    credentials:'include',
    headers: {
      "Accept":"*/*",
...
<div className="login">
        <div className="login_form-container">
            <h2 style={{textAlign:'center'}}>Login Scorer Account</h2>
           <p style={{marginBottom:'0.5rem',display:'flex',alignItems:'center',justifyContent:'space-between'}}> <span>Doesn't have an account yet? <Link to="/signup/scorer">Sign up</Link></span><svg svg id="Layer_1" style={{height:'50px',width:'50px'}} viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <style type="text/css">{`
      .st0 { fill: #F0C4DB; }
      .st1 { fill: #FF9D9C; }
  ...
  <g>
    <path className="st5" d="M2.91,24.2c2.09,0.84,4.36,1.32,6.75,1.32c9.95,0,18.01-8.06,18.01-18.01c0-2.25-0.43-4.4-1.19-6.38H2.91V24.2z"/>
    <g>
      <path className="st6" d="M46.07,48.12H7.21c0.06-8.88,6.07-16.33,14.24-18.59l5.19,8.99l5.19-8.99C40,31.79,46.01,39.25,46.07,48.12z"/>
      <path className="st2" d="M39.33,16.2v-2.77l-3.97-0.75c-0.21-0.9-0.57-1.75-1.04-2.52l2.28-3.34l-1.96-1.96L31.3,7.14c-0.77-0.47-1.62-0.83-2.53-1.04l-0.75-3.97h-2.77L24.51,6.1c-0.9,0.21-1.76,0.57-2.53,1.04l-3.34-2.28l-1.96,1.96l2.28,3.34c-0.47,0.77-0.83,1.62-1.04,2.52l-3.97,0.75v2.77l3.97,0.75c0.21,0.9,0.57,1.75,1.04,2.52l-2.28,3.34l1.96,1.96l3.34-2.28c0.77,0.47,1.62,0.83,2.52,1.05l0.75,3.97h2.77l0.75-3.97c0.9-0.21,1.75-0.57,2.52-1.05l3.34,2.28l1.96-1.96l-2.28-3.34c0.47-0.77,0.83-1.62,1.04-2.52L39.33,16.2z M26.64,18.97c-2.3,0-4.16-1.86-4.16-4.16c0-2.3,1.86-4.16,4.16-4.16s4.16,1.86,4.16,4.16C30.8,17.11,28.94,18.97,26.64,18.97z"/>
      <g>
        <path className="st4" d="M32.3,28.81c-0.32-0.09-0.68,0.05-0.85,0.35l-4.54,7.86l-4.54-7.86c-0.17-0.3-0.52-0.44-0.85-0.35C12.88,31.2,6.8,39.14,6.73,48.12c0,0.2,0.08,0.39,0.22,0.53c0.14,0.14,0.33,0.22,0.53,0.22h38.85c0.2,0,0.39-0.08,0.53-0.22c0.14-0.14,0.22-0.33,0.22-0.53C47.02,39.14,40.94,31.2,32.3,28.81z"/>
        <path className="st2" d="M39.33,16.2v-2.77l-3.97-0.75c-0.21-0.9-0.57-1.75-1.04-2.52l2.28-3.34l-1.96-1.96L31.3,7.14c-0.77-0.47-1.62-0.83-2.53-1.04l-0.75-3.97h-2.77L24.51,6.1c-0.9,0.21-1.76,0.57-2.53,1.04l-3.34-2.28l-1.96,1.96l2.28,3.34c-0.47,0.77-0.83,1.62-1.04,2.52l-3.97,0.75v2.77l3.97,0.75c0.21,0.9,0.57,1.75,1.04,2.52l-2.28,3.34l1.96,1.96l3.34-2.28c0.77,0.47,1.62,0.83,2.52,1.05l0.75,3.97h2.77l0.75-3.97c0.9-0.21,1.75-0.57,2.52-1.05l3.34,2.28l1.96-1.96l-2.28-3.34c0.47-0.77,0.83-1.62,1.04-2.52L39.33,16.2z M26.64,18.97c-2.3,0-4.16-1.86-4.16-4.16c0-2.3,1.86-4.16,4.16-4.16s4.16,1.86,4.16,4.16C30.8,17.11,28.94,18.97,26.64,18.97z"/>
